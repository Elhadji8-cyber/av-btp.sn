...
export const ModernisezProject = function(){
    return(
        <section className="flex flex-col items-center justify-center bg-fuchsia-400 mt-12 md:mt-20 p-6 sm:p-12 md:p-20 mb-10">
            <div className="w-full max-w-4xl text-center">
                ...
                className="text-3xl sm:text-4xl md:text-6xl font-bold text-white mb-4 sm:mb-5">
                    Modernisez Vos Projets avec le BIM
                </motion.h1>
                <motion.p 
                initial={{opacity:0, y:30}}
                ...
                className="text-white text-base sm:text-lg md:text-xl px-2 sm:px-8">
                    Découvrez comment la modélisation BIM peut transformer votre façon de concevoir et
                    <span className="block">construire. Demandez une démonstration personnalisée.</span>
                </motion.p>
            </div>
