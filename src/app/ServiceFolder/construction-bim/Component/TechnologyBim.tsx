...
export const TechnologyBim = function(){
    return(
            <section className="flex flex-col lg:flex-row justify-center items-center gap-10 mt-20 p-4 md:p-10">
               ...
               className="h-fit lg:h-[500px] w-full lg:w-[600px] flex flex-col gap-5">
                    {/* texte */}
                    <h2 className="text-3xl sm:text-4xl md:text-5xl text-fuchsia-400 font-bold p-2">Technologies BIM Avancées</h2>
                    ...
                    <main className="flex items-center gap-4">
                       ...
                       <FaSkyatlas className="h-10 w-10"/>
                       </div>
                       <article>
                    ...
                    <main className="flex items-center gap-4">
                        <div className="p-2 bg-fuchsia-200 rounded-full">
                         <GrVirtualMachine  className="h-10 w-10"/>
                       </div>
                       <article>
