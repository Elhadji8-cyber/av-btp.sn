...
export const DemarrageConstruction = function(){
             return(
                      <section className="flex flex-col items-center justify-center bg-rose-400 mt-12 md:mt-20 p-6 sm:p-12 md:p-20 mb-10">
                                     <div className="w-full max-w-4xl text-center">
                                         <motion.h1
                                         initial={{opacity:0, y:30}}
                                         whileInView={{opacity:1, transition:{duration:1, delay:0.1}, y:0}}
                                         ...
                                         className="text-white text-base sm:text-lg md:text-xl px-2 sm:px-8">
                                             Que ce soit pour du gros œuvre, des finitions ou des travaux publics, notre équipe de
                                             <span className="block">professionnels est prête à réaliser vos projets.</span>
                                         </motion.p>
                                     </div>
