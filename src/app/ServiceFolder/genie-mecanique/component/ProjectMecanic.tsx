...
import image1 from "../image/mecanique1.jpg"
import image2 from "../image/mecanique2.jpg";
import image3 from "../image/mecanique3.jpg"
...
const ProjectCardsItems : ProjectCards[] = [
    {image: image1,
        text:'Industriel',
        title: "Usine Textile Thiès",
        description: " Installation complète de systèmes de ventilation et climatisation.",
        link: "../../../ContactSection"
    },
    {image:  image2,
        text:'Commercial',
        title: "Centre Commercial Dakars",
        description: "Système de climatisation centralisée pour 15000m² de surface.",
        link: "../../../ContactSection"
    },
    {image:  image3,
        text:'Médical',
        title: "Hôpital Régional",
        description: "Systèmes de ventilation spécialisés pour blocs opératoires.",
        link: "../../../ContactSection"
    }
]

                  export  const ProjectMecanic = function(){
                       return(
                            <section className="flex flex-col justify-center items-center p-10 mt-20 bg-neutral-100">
                                          <div>
                                            ...
                                            className="text-6xl text-center font-bold mb-5">Réalisations Mécaniques</motion.h1>
                                            <motion.p 
                                            initial={{opacity:0, y:30}}
                                            whileInView={{opacity:1, transition:{duration:1, delay:0.2}, y:0}}
                                            >
                                                Découvrez nos projets d'installations mécaniques et industrielles.
                                            </motion.p>
                                          </div>
                                      ...
                                      >
                                            ...
                                            <Image
                                             ...
                                             className="object-cover block transform hover:scale-105 transition-transform duration-300 ease-in-out"
                                              />
                                               <p className="absolute left-3 top-3 z-20 bg-green-400 text-white px-3 py-1 rounded-md text-sm">
                                           {item.text}
                                             </p>
                                              </div>
                                         ...
                                         <h3 className="font-semibold text-lg md:text-xl text-gray-900">{item.title}</h3>
                                            ...
                                            <Link href={item.link} className="inline-block text-white text-sm p-2 bg-green-400 rounded-full w-fit">
                                                   Demande un Devis
                                                  </Link>
                                                </div>
                                               </motion.div>
